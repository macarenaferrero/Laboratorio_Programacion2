...
namespace CuentaGanadoForm
{
    public partial class FormContador : Form
    {
        ...
        private void numEmpleados_ValueChanged(object sender, EventArgs e)
        {
            if (numEmpleados.Value > empleados)
            {
                ...
                if (resultado == DialogResult.OK)
                {
                    ...
                    if (this.bar + new Empleados(short.Parse(edad), nombre,int.Parse(dni)))
                    {
                        this.dataGridView1.DataSource = null;
                        this.dataGridView1.DataSource = bar.Empleados;
        ...
        private void agregarGenteToolStripMenuItem_Click(object sender, EventArgs e)
        {
