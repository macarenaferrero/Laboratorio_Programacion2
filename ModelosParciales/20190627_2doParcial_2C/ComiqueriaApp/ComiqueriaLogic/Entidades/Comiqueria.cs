...
namespace ComiqueriaLogic
{
    public class Comiqueria
    {
        ...
        public Comiqueria()
        {
             ...
             */
            this.Productos = ProductosBD.SelectAll();
            ProductosBD.ProductoBDCambiado += ActualizarLista;
            this.ventas = new List<Venta>();

        }

        //Tiene que recibir el mismo parametro que indica el delegado
        private void ActualizarLista(AccionesDB acciones)
        {
            this.productos = ProductosBD.SelectAll();
        }
